...
class WCBEF_Post
{
    ...
    public function settings()
    {
        ...
        $this->redirect('settings', esc_html__('Success !', WCBEF_NAME));
    }
                ...
                if (!empty($_POST['email']) && !empty($_POST['industry'])) {
                    ...
                    if (!empty($info) && is_array($info)) {
                        if (!empty($info['result']) && $info['result'] == true) {
                            ...
                            $message = (!empty($info['message'])) ? esc_html($info['message']) : esc_html__('System Error !', WCBEF_NAME);
                        }
                    } else {
                        update_option('wcbef_is_active', 'no');
                        $message = esc_html__('Connection Timeout! Please Try Again', WCBEF_NAME);
                    }
                }
            }
        }
