                ...
                if ($column['editable'] === true) {
                    switch ($column['content_type']) {
                        ...
                        case 'checkbox':
                            ...
                            $output .= "<label><input type='checkbox' data-field='" . esc_attr($key_decoded) . "' data-field-type='" . esc_attr($meta_field) . "' data-product-id='" . esc_attr($product['id']) . "' value='yes' class='wcbef-dual-mode-checkbox wcbef-inline-edit-action' " . esc_attr($checked) . "><span>" . esc_html__('Yes', WCBEF_NAME) . "</span></label>";
                            break;
                        case 'select_files':
    ...
    public static function get_default_columns1()
    {
        return [
            '_thumbnail_id' => [
                ...
                'title' => esc_html__('Thumbnail', WCBEF_NAME),
                'editable' => true,
                'content_type' => 'image',
            ...
            'post_content' => [
                ...
                'title' => esc_html__('Description', WCBEF_NAME),
                'editable' => true,
            ...
            'manage_stock' => [
                ...
                'title' => esc_html__('Manage Stock', WCBEF_NAME),
                'editable' => true,
                'sortable' => true,
            ...
            'regular_price' => [
                ...
                'title' => esc_html__('Regular Price', WCBEF_NAME),
                'editable' => true,
                'sortable' => true,
            ...
            'post_status' => [
                ...
                'title' => esc_html__('Status', WCBEF_NAME),
                'editable' => true,
                'content_type' => 'select',
            ...
            'post_date' => [
                'label' => esc_html__('Post Published', WCBEF_NAME),
                'title' => esc_html__('Post Published', WCBEF_NAME),
                'editable' => true,
                'content_type' => 'date',
                'allowed_type' => ['simple', 'variable', 'grouped', 'external', 'variation'],
                'background_color' => '#fff',
            ...
            'product_cat' => [
                'label' => esc_html__('Categories', WCBEF_NAME),
                'title' => esc_html__('Categories', WCBEF_NAME),
                'editable' => true,
    ...
    public static function get_default_columns2()
    {
        return [
            ...
            'gallery' => [
                ...
                'title' => esc_html__('Gallery', WCBEF_NAME),
                'editable' => true,
            ...
            'sale_price' => [
                ...
                'title' => esc_html__('Sale Price', WCBEF_NAME),
                'editable' => true,
                'sortable' => true,
    ...
    public static function get_default_columns3()
    {
        return [
            ...
            'post_excerpt' => [
                ...
                'title' => esc_html__('Short Description', WCBEF_NAME),
                'editable' => true,
                'content_type' => 'textarea',
                'allowed_type' => ['simple', 'variable', 'grouped', 'external'],
                'background_color' => '#fff',
            ...
            'sku' => [
                ...
                'title' => esc_html__('SKU', WCBEF_NAME),
                'editable' => true,
                'sortable' => true,
                'content_type' => 'text',
                'allowed_type' => ['simple', 'variable', 'grouped', 'external', 'variation'],
