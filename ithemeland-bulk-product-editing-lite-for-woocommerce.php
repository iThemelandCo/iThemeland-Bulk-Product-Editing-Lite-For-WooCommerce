...
define('WCBEF_NAME', 'woocommerce-bulk-edit-free');
define('WCBEF_LABEL', 'iThemeland Bulk Product Editing Lite For WooCommerce');
...
define('WCBEF_LANGUAGES_DIR', dirname(plugin_basename(__FILE__)) . '/languages/');
...
define('WCBEF_VERSION', '3.1');
define('WCBEF_UPGRADE_URL', 'https://ithemelandco.com/plugins/woocommerce-bulk-product-editing?utm_source=free_plugins&utm_medium=plugin_links&utm_campaign=user-lite-buy');
