<div class="wcbef-wrap">
    <div class="wcbef-tab-middle-content">
        <div class="wcbef-alert wcbef-alert-default">
            <span><?php esc_html_e('List of your changes and possible to roll back to the previous data', WCBEF_NAME); ?></span>
        </div>
        ...
        <div class="wcbef-history-filter">
            <div class="wcbef-history-filter-fields">
                <div class="wcbef-history-filter-field-item">
                    <label for="wcbef-history-filter-operation"><?php esc_html_e('Operation', WCBEF_NAME); ?></label>
                ...
                <div class="wcbef-history-filter-field-item">
                    <label for="wcbef-history-filter-author"><?php esc_html_e('Author', WCBEF_NAME); ?></label>
                ...
                <div class="wcbef-history-filter-field-item">
                    <label for="wcbef-history-filter-fields"><?php esc_html_e('Fields', WCBEF_NAME); ?></label>
                ...
                <div class="wcbef-history-filter-field-item wcbef-history-filter-field-date">
                    ...
                    <input type="text" id="wcbef-history-filter-date-from" class="wcbef-datepicker wcbef-date-from" data-to-id="wcbef-history-filter-date-to" placeholder="<?php esc_html_e('From ...', WCBEF_NAME); ?>">
                    <input type="text" id="wcbef-history-filter-date-to" class="wcbef-datepicker" placeholder="<?php esc_html_e('To ...', WCBEF_NAME); ?>">
                </div>
            </div>
            <div class="wcbef-history-filter-buttons">
                ...
                <div class="wcbef-history-filter-buttons-right">
                    ...
                    <button type="button" class="wcbef-button wcbef-button-lg wcbef-button-red" disabled="disabled">
                        ...
                        <span><?php esc_html_e('Clear History', WCBEF_NAME); ?></span>
                    </button>
                </div>
            </div>
        </div>
        <div class="wcbef-history-items">
            <h3><?php esc_html_e('Column(s)', WCBEF_NAME); ?></h3>
                ...
                <div class="wcbef-table-border-radius">
                    <table>
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php esc_html_e('History Name', WCBEF_NAME); ?></th>
                                <th><?php esc_html_e('Author', WCBEF_NAME); ?></th>
                                <th class="wcbef-mw125"><?php esc_html_e('Date Modified', WCBEF_NAME); ?></th>
                                <th class="wcbef-mw250"><?php esc_html_e('Actions', WCBEF_NAME); ?></th>
                            </tr>
                        </thead>
                        <tbody>
