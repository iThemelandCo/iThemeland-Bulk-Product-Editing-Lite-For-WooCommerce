        ...
        <div class="wcbef-modal-box wcbef-modal-box-sm">
            <div class="wcbef-modal-content">
                <div class="wcbef-modal-title">
                    <h2><?php esc_html_e('New Product', WCBEF_NAME); ?></h2>
                    ...
                    <div class="wcbef-wrap">
                        <div class="wcbef-filters-form-group">
                            <label class="wcbef-label-big" for="wcbef-new-product-count">
                                <?php esc_html_e('Enter how many new product(s) to create!', WCBEF_NAME); ?>
                            </label>
                            <input type="number" class="wcbef-input-numeric-sm" id="wcbef-new-product-count" value="1" placeholder="<?php esc_html_e('Number ...', WCBEF_NAME); ?>">
                        </div>
                    </div>
                </div>
                <div class="wcbef-modal-footer">
                    <button type="button" class="wcbef-button wcbef-button-blue" id="wcbef-create-new-product"><?php esc_html_e('Create', WCBEF_NAME); ?></button>
                </div>
            </div>
        </div>
    </div>
