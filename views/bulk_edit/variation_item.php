<div class="wcbef-variation-bulk-edit-current-item">
    ...
    <div class="wcbef-variation-bulk-edit-current-item-radio">
        <input type="radio" name="default_variation" value="<?php echo (!empty($attribute_value)) ? esc_attr(urldecode($attribute_value)) : ''; ?>" title="<?php esc_html_e('Set as default', WCBEF_NAME); ?>" <?php echo (!empty($variation_attributes) && !empty($default_variation) && $default_variation == $variation_attributes) ? "checked='checked'" : ''; ?>>
    </div>
</div>