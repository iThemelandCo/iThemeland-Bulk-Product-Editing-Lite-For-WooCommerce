<table id="wcbef-products-list">
    <thead>
        <tr>
            ...
            <th class="wcbef-td70 <?php echo (wcbef\classes\helpers\Session::has('sticky_first_columns') && wcbef\classes\helpers\Session::get('sticky_first_columns') == 'yes') ? 'wcbef-td-sticky wcbef-td-sticky-id' : ''; ?>">
                <input type="checkbox" class="wcbef-check-item-main" title="<?php esc_html_e('Select All', WCBEF_NAME); ?>">
                <label data-column-name="id" class="wcbef-sortable-column"><?php esc_html_e('ID', WCBEF_NAME); ?><span class="wcbef-sortable-column-icon"><?php echo sprintf('%s', $sortable_icon); ?></span></span>
            </th>
            <?php
    ...
    <tbody>
        <?php if (!empty($products_loading)) : ?>
            <tr>
                <td colspan="8" class="wcbef-text-alert"><?php esc_html_e('Loading ...', WCBEF_NAME); ?></td>
            </tr>
        <?php elseif (!empty($products) && count($products->posts) > 0) :
            ...
            <tr>
                <td colspan="8" class="wcbef-text-alert"><?php esc_html_e('No Data Available!', WCBEF_NAME); ?></td>
            </tr>
        <?php endif; ?>
    </tbody>
    <tfoot>
