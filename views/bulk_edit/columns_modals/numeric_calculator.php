        ...
        <div class="wcbef-modal-box wcbef-modal-box-sm">
            <div class="wcbef-modal-content">
                <div class="wcbef-modal-title">
                    <h2><?php esc_html_e('Calculator', WCBEF_NAME); ?> - <span id="wcbef-modal-numeric-calculator-product-title" class="wcbef-modal-product-title"></span></h2>
                ...
                <div class="wcbef-modal-body">
                    <div class="wcbef-wrap">
                        <select id="wcbef-numeric-calculator-operator" title="<?php esc_html_e('Select Operator', WCBEF_NAME); ?>">
                            <option value="+">+</option>
                            <option value="-">-</option>
                            <option value="replace"><?php esc_html_e('replace', WCBEF_NAME); ?></option>
                        </select>
                        <input type="number" placeholder="<?php esc_html_e('Enter Value ...', WCBEF_NAME); ?>" id="wcbef-numeric-calculator-value" title="<?php esc_html_e('Value', WCBEF_NAME); ?>">
                    </div>
                </div>
