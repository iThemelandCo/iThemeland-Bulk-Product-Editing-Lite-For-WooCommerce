jQuery(document).ready(function ($) {
    ...
    if ($("#wcbef-bulk-edit-navigation").length > 0) {
    ...
    $(document).on('click', '#wcbef-activation-activate', function () {
        $('#wcbef-activation-type').val('activate');

        if ($('#wcbef-activation-email').val() != '') {
            if ($('#wcbef-activation-industry').val() != '') {
                setTimeout(function () {
                    $('#wcbef-activation-form').first().submit();
                }, 200)
            } else {
                swal({
    ...
    $(document).on('click', '#wcbef-activation-skip', function () {
        $('#wcbef-activation-type').val('skip');
